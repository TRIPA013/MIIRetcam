...
import com.kbeanie.imagechooser.CameraActivity;
...
public class ImageChooserManager extends BChooser implements
    ...
    private String takePicture() throws ChooserException {
        ...
        activity.startActivityForResult(intent, ChooserType.REQUEST_CAPTURE_PICTURE);
    ...
    public void submit(int requestCode, Intent data) {
        try {
            if (requestCode != type) {
                Log.i("ICA" , " submit :onError " +requestCode );
                onError("onActivityResult requestCode is different from the type the chooser was initialized with.");
            } else {
                Log.i("ICA" , " requestCode "  );
                switch (requestCode) {
                    case ChooserType.REQUEST_PICK_PICTURE:
